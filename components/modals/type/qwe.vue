...
<template>
    <div
      class="flex w-full flex-col items-center justify-center py-8 text-slate-800 sm:px-5 xl:px-10 xl:py-28 dark:text-slate-100"
    >
      <!-- File Upload Section -->
      ...
      >
        ...
        >
          ...
          <div v-else class="flex flex-col items-center gap-4">
            <DocumentIcon class="size-6 text-indigo-400 dark:text-slate-100" />
            ...
            <button
              class="rounded-full bg-gradient-to-br from-indigo-400 to-indigo-300 px-4 py-2
               text-xs text-slate-100 shadow-md shadow-indigo-400 hover:from-indigo-300 hover:to-indigo-400 
               focus:border-2 focus:border-indigo-500 focus:outline-none md:text-base dark:from-slate-900 
               dark:to-slate-700 dark:text-slate-100 dark:shadow-slate-800 hover:dark:from-slate-700 
               hover:dark:to-slate-900 focus:dark:border-slate-400"
